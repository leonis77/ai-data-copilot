    ...
    <>
      <motion.nav
        ...
        style={{
          ...
          background: scrolled ? "rgba(11,15,23,0.8)" : "rgba(11,15,23,0.4)",
        }}
      >
        <div className="mx-auto max-w-7xl px-4 md:px-6 h-full flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-2.5 md:gap-3 group shrink-0">
            <motion.div
              ...
              className="w-8 h-8 md:w-9 md:h-9 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center shadow-lg shadow-indigo-500/20 group-hover:shadow-indigo-500/30 transition-shadow"
            >
                      ...
                      >
                        <Link href={item.href}
                          ...
                          className={cn(
                            ...
                            active
                              ? "text-white bg-white/[0.08] border border-white/[0.08] shadow-lg shadow-indigo-500/5"
                              : "text-white/50 hover:text-white/80 hover:bg-white/[0.04]"
                          )}>
                          <item.icon className={cn("w-5 h-5", active ? "text-indigo-400" : "text-white/30")} />
                          <span>{item.label}</span>
                          {active && <span className="ml-auto w-1.5 h-1.5 rounded-full bg-indigo-400 shadow-[0_0_8px_rgba(99,102,241,0.5)]" />}
                        </Link>
                      </motion.div>
                    );
                  })}
