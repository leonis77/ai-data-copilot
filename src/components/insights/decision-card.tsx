...
export function DecisionCard({ title, description, impact, priority, index = 0 }: DecisionCardProps) {
  ...
  const glowColor = priority === "P0" ? "rgba(239,68,68,0.08)" : priority === "P1" ? "rgba(251,191,36,0.08)" : "rgba(56,189,248,0.08)";
  ...
  return (
    <motion.div
      ...
      whileHover={{ scale: 1.02, borderColor: "#7C5CFF", transition: { duration: 0.2 } }}
