  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2.5 mb-4">
        ...
        <div>
          <h2 className="text-heading">场景模拟</h2>
          <p className="text-caption">调整参数，实时预览经营变化</p>
        </div>
        <span className="text-caption text-white/20 ml-auto">{scenarios.scenarios.length} 个预设场景</span>
      </div>
        ...
        >
          <div className="relative">
            <div className="flex items-center gap-2 mb-4">
              <div className="icon-box-sm bg-indigo-500/10">
                <SlidersHorizontal className="w-3.5 h-3.5 text-indigo-400" />
              </div>
              <h3 className="text-heading">价格调整模拟</h3>
            </div>

            {/* Product selector */}
            <div className="mb-4">
              <label className="text-caption text-white/40 block mb-1.5 uppercase tracking-wider font-medium">选择商品</label>
                ...
                {profitResults.slice(0, 5).map(function(pr, i) {
                  ...
                  return (
                    <button
                      ...
                      className={"text-caption px-2.5 py-1.5 rounded-lg border transition-all " + (
                        isActive
            ...
            <div className="mb-4">
              <div className="flex items-center justify-between mb-2">
                <label className="text-caption text-white/40 uppercase tracking-wider font-medium">调整幅度</label>
              ...
              <div className="flex justify-between mt-1.5">
                <span className="text-caption text-white/15">-30%</span>
                <span className="text-caption text-white/25">0%</span>
                <span className="text-caption text-white/15">+30%</span>
              </div>
            </div>
            ...
            {interactivePriceScenario && (
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between p-3 rounded-lg bg-white/[0.02] border border-white/[0.04]">
                  <div>
                    <div className="text-caption text-white/25 uppercase tracking-wider">原售价</div>
                  ...
                  <div className="text-right">
                    <div className="text-caption text-white/25 uppercase tracking-wider">新售价</div>
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  <div className="p-3 rounded-lg bg-white/[0.02] border border-white/[0.04]">
                    <div className="text-caption text-white/25 mb-1 uppercase tracking-wider">原月利润</div>
                    ...
                    <div className="text-caption text-white/25">利润率 {interactivePriceScenario.originalProfitMargin.toFixed(1)}%</div>
                  </div>
                  <div className="p-3 rounded-lg bg-indigo-500/[0.04] border border-indigo-500/10">
                    <div className="text-caption text-indigo-400/60 mb-1 uppercase tracking-wider">新月利润</div>
                    ...
                    <div className="text-caption text-indigo-400/50">利润率 {interactivePriceScenario.newProfitMargin.toFixed(1)}%</div>
                  </div>
                </div>
                ...
                <div className={"p-3 rounded-lg border " + (
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-caption text-white/30 uppercase tracking-wider font-medium">利润变化</span>
                    <span className={"text-caption px-2 py-0.5 rounded-md border " + CONFIDENCE_CONFIG[interactivePriceScenario.confidence].bg + " " + CONFIDENCE_CONFIG[interactivePriceScenario.confidence].text + " " + CONFIDENCE_CONFIG[interactivePriceScenario.confidence].border}>
                ...
                {/* Recommendation */}
                <div className="p-3 rounded-lg bg-white/[0.02] border border-white/[0.04]">
                  <p className="text-body">{interactivePriceScenario.recommendation}</p>
                </div>
              </div>
            )}
          </div>
        ...
        <div className="space-y-4">
          ...
          >
            <div className="relative">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-heading">跨平台切换模拟</h3>
              </div>

              {/* Platform selector */}
              <div className="mb-4">
                <label className="text-caption text-white/40 block mb-1.5 uppercase tracking-wider font-medium">
                ...
                <div className="space-y-3">
                  <div className="grid grid-cols-2 gap-2.5">
                    <div className="p-3 rounded-lg bg-white/[0.02] border border-white/[0.06]">
                      <div className="text-caption text-white/40 mb-1 uppercase tracking-wider">当前平台月利润</div>
                    ...
                    <div className="p-3 rounded-lg bg-cyan-500/[0.04] border border-cyan-500/10">
                      <div className="text-caption text-cyan-400/60 mb-1 uppercase tracking-wider">
                  ...
                  <div className={"p-3 rounded-lg border " + (
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-caption text-white/40 uppercase tracking-wider font-medium">利润差异</span>
                      <span className={"text-caption px-2 py-0.5 rounded-md border " + CONFIDENCE_CONFIG[interactivePlatformScenario.confidence].bg + " " + CONFIDENCE_CONFIG[interactivePlatformScenario.confidence].text + " " + CONFIDENCE_CONFIG[interactivePlatformScenario.confidence].border}>
                  ...
                  <div className="p-3 rounded-lg bg-white/[0.02] border border-white/[0.06]">
                    <p className="text-body">{interactivePlatformScenario.recommendation}</p>
                  </div>
                </div>
              ) : (
                <div className="text-body text-white/20 text-center py-4">
                  请选择目标平台查看切换收益
                </div>
              )}
            </div>
          ...
          {stopLossScenario.productsToStop.length > 0 && (
            <motion.div
              ...
              className="card p-5 border-red-500/10"
            >
              <div className="relative">
                <div className="flex items-center gap-2 mb-3">
                  <div className="icon-box-sm bg-red-500/10">
                    <Shield className="w-3.5 h-3.5 text-red-400" />
                  </div>
                  <h3 className="text-heading">止损模拟</h3>
                </div>
                  ...
                  {stopLossScenario.productsToStop.map(function(p, i) {
                    return (
                      <div key={i} className="flex items-center justify-between p-2.5 rounded-lg bg-red-500/[0.04] border border-red-500/[0.08]">
                        <div>
                          <span className="text-sm text-white/70 font-medium">{p.productName}</span>
                          <span className="text-caption text-white/25 ml-1.5">{p.platform}</span>
                        </div>
                ...
                <div className="p-3 rounded-lg bg-white/[0.02] border border-white/[0.06]">
                  <div className="flex items-center justify-between mb-1">
                    <span className="text-caption text-white/40 uppercase tracking-wider font-medium">止损后月收益</span>
                    <span className={"text-caption px-2 py-0.5 rounded-md border " + CONFIDENCE_CONFIG[stopLossScenario.confidence].bg + " " + CONFIDENCE_CONFIG[stopLossScenario.confidence].text + " " + CONFIDENCE_CONFIG[stopLossScenario.confidence].border}>
                  ...
                  <div className="text-caption text-white/25 mt-1">
                ...
                <div className="p-3 rounded-lg bg-white/[0.02] border border-white/[0.06] mt-3">
                  <p className="text-body">{stopLossScenario.recommendation}</p>
                </div>
              </div>
            </motion.div>
          )}
          ...
          {scenarios.scenarios.length > 0 && (
            <div className="card p-5 border-white/[0.06]">
              <div className="text-caption text-white/30 mb-2 uppercase tracking-wider font-medium">AI 预设场景摘要</div>
              <p className="text-body text-white/50 leading-relaxed whitespace-pre-wrap">{scenarios.summary}</p>
            </div>
          )}
        </div>
      </div>
