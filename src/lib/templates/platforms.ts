...
var tmallOrder: PlatformTemplate = {
  ...
  matchRules: {
    requiredColumns: ["订单编号", "买家昵称"],
    optionalColumns: ["实付金额", "下单时间", "订单状态", "收货地址"],
...
var taobaoOrder: PlatformTemplate = {
  ...
  matchRules: {
    requiredColumns: ["订单号", "买家会员名"],
    optionalColumns: ["商品类目", "下单时间", "金额"],
    columnCountRange: [8, 35],
  },
  fieldMap: {
    "订单号": { standard: "order_id", role: "identifier", aliases: ["订单编号", "订单ID"] },
    "商品标题": { standard: "product_name", role: "entity_name", aliases: ["商品名称", "商品", "宝贝名称", "产品"] },
    "数量": { standard: "quantity", role: "quantity", aliases: ["件数", "购买数量"] },
    ...
    "收货地址": { standard: "delivery_address", role: "location", aliases: ["地址", "收货地址", "收货省份", "收货人地址"] },
    "买家会员名": { standard: "buyer_name", role: "entity_name", businessConcept: "customer_name", aliases: ["买家", "买家ID"] },
  },
  parseRules: { headerRowStrategy: "first_row", dateFormat: "yyyy-MM-dd HH:mm:ss" },
};
...
var pddOrder: PlatformTemplate = {
  ...
  matchRules: {
    requiredColumns: ["拼团订单号", "拼团金额"],
    optionalColumns: ["拼团时间", "收货城市", "商品标题"],
    columnCountRange: [8, 30],
  },
  fieldMap: {
    "拼团订单号": { standard: "order_id", role: "identifier", aliases: ["订单号", "订单编号", "订单ID"] },
    "商品名称": { standard: "product_name", role: "entity_name", aliases: ["商品标题", "商品", "产品名称"] },
    "商品类目": { standard: "category", role: "category", aliases: ["类目", "分类", "品类"] },
    "拼单价": { standard: "unit_price", role: "money", aliases: ["拼团价", "单价"] },
    "拼团金额": { standard: "paid_amount", role: "money", businessConcept: "selling_price", aliases: ["拼团金额(元)", "成交金额", "订单金额", "支付金额"] },
    "拼团销量": { standard: "quantity", role: "quantity", aliases: ["销量", "销售数量", "拼单量"] },
    "买家昵称": { standard: "buyer_name", role: "entity_name", aliases: ["买家", "买家ID"] },
    "收货城市": { standard: "delivery_address", role: "location", aliases: ["收货地址", "地址", "收货人地址"] },
  },
  parseRules: { headerRowStrategy: "first_row", dateFormat: "yyyy-MM-dd HH:mm:ss" },
};
...
var douyinOrder: PlatformTemplate = {
  ...
  matchRules: {
    requiredColumns: ["抖音订单号", "抖音售价", "买家昵称"],
    optionalColumns: ["直播日期", "实收金额"],
    columnCountRange: [8, 30],
  },
  fieldMap: {
    "抖音订单号": { standard: "order_id", role: "identifier", aliases: ["订单号", "订单ID", "订单编号"] },
    "商品名称": { standard: "product_name", role: "entity_name", aliases: ["商品标题", "商品"] },
    "商品类目": { standard: "category", role: "category", aliases: ["类目", "分类", "品类"] },
    "数量": { standard: "quantity", role: "quantity", aliases: ["件数"] },
    "抖音售价": { standard: "paid_amount", role: "money", businessConcept: "selling_price", aliases: ["抖音售价(元)", "实付金额", "支付金额", "成交价"] },
    "实收金额": { standard: "revenue", role: "money", aliases: ["实收金额(元)", "成交金额", "GMV"] },
    "创建时间": { standard: "order_time", role: "datetime", aliases: ["下单时间", "购买时间"] },
    "直播日期": { standard: "order_time", role: "datetime", aliases: ["直播时间", "开播日期"] },
...
var jdOrder: PlatformTemplate = {
  ...
  matchRules: {
    requiredColumns: ["订单号", "收货地址"],
    optionalColumns: ["下单时间"],
    columnCountRange: [8, 30],
  },
  fieldMap: {
...
var taobaoRefund: PlatformTemplate = {
  ...
  matchRules: {
    requiredColumns: ["退款编号", "退款金额", "商品"],
    optionalColumns: ["原因", "时间"],
    columnCountRange: [6, 25],
  },
  fieldMap: {
...
var genericInventory: PlatformTemplate = {
  ...
  matchRules: {
    requiredColumns: ["商品", "库存", "仓库"],
    requiredMatchRate: 0.67,
    optionalColumns: ["库龄", "安全库存", "可用库存"],
...
var genericProduct: PlatformTemplate = {
  ...
  matchRules: {
    requiredColumns: ["商品", "类目", "价格"],
    requiredMatchRate: 0.67,
    optionalColumns: ["规格", "状态", "上架时间"],
    columnCountRange: [3, 20],
  },
  fieldMap: {
...
var genericSupply: PlatformTemplate = {
  ...
  matchRules: {
    requiredColumns: ["商品", "价格", "供应商"],
    requiredMatchRate: 0.67,
    optionalColumns: ["规格", "起订量", "产地"],
